...
# ============================================================
st.set_page_config(
    page_title="E-Commerce Dashboard | Azlinsyah Fadhilah Meran",
    layout="wide",
...
st.markdown('<p class="sub-header">Analisis interaktif data e-commerce Brasil | '
            'Azlinsyah Fadhilah Meran</p>', unsafe_allow_html=True)
...
st.markdown(
    ...
    "Dibuat oleh <strong>Azlinsyah Fadhilah Meran</strong> | "
    "CodingCamp DBS 2026</p>",
    unsafe_allow_html=True
)
